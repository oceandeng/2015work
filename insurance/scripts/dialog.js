...
(function(G, D) {
    ...
    function Dialog(o) {
        ...
        this.config_bConStyle = o.bConStyle || {};
        this.config_fStyle = o.fStyle || {};
        this.config_iStyle = o.iStyle || {};
    ...
    Dialog.prototype.create = function() {
        ...
        switch(this.config_type){
            case "input":
                ...
                html += "<div class='D_alert'><input id='inviteNum' type='tel' value = '' placeholder='输入要添加的手机号' /></div>";
                ...
                this.iBox = this.bCon.querySelector('input');
                this.foot = foot;
            ...
            case "alert":
                ...
                this.bCon = body.querySelector('.D_alert');
                this.foot = foot;
                this.fSub = foot.querySelector('.D_submit');
                this.fCan = foot.querySelector('.D_cancel');
                this.closeBtn = D.querySelector('.D_close');
                break;
            case "tips":
                content.className = "D_content";
            ...
            case "popup":
                ...
                if (this.config_showButtons) {
                    if (this.config_submitButton) {
                        btn_html += '<input type="button" value="' + this.config_submitButton + '" class="D_submit" data-dialog-submit/>';
                    }
                    if (this.config_cancelButton) {
                        btn_html += '<input type="button" value="' + this.config_cancelButton + '" class="D_cancel" data-dialog-cancel />';
                    }
                ...
                this.body = body;
                this.head = head;
                this.bSub = btn.querySelector('input');
                this.closeBtn = D.querySelector('.D_close');
                break;
        }
    ...
    Dialog.prototype.setStyle = function() {
        ...
        if(this.body){
            ...
            setStyle(this.foot, this.config_fStyle || {
                // 'position': 'absolute',
                'width': '90%',
                'padding': '0 5% 20px 5%',
                'left': '0',
            ...
            setStyle(this.iBox, this.config_iStyle);
            setStyle(this.bSub, this.config_subStyle);
            setStyle(this.fSub, this.config_subStyle);
            setStyle(this.fCan, this.config_canStyle);
            setStyle(this.fBtn, this.config_subStyle);
            setStyle(this.bCon, this.config_bConStyle || {
                'padding': '20px 10px'
            });
            setStyle(this.bTips, {
                'position': 'relative'
