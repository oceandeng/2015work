...
window.JpegMeta.JpegFile.prototype.toString = function() {
...
window.JpegMeta.JpegFile.prototype._SOI_MARKER = '\xff\xd8';
window.JpegMeta.JpegFile.prototype._DELIM = 0xff;
window.JpegMeta.JpegFile.prototype._EOI = 0xd9;
window.JpegMeta.JpegFile.prototype._SOS = 0xda;
window.JpegMeta.JpegFile.prototype._sofHandler = function _sofHandler(mark, pos) {
    if (this.general !== undefined) {
...
window.JpegMeta.JpegFile.prototype._JFIF_IDENT = "JFIF\x00";
window.JpegMeta.JpegFile.prototype._JFXX_IDENT = "JFXX\x00";
window.JpegMeta.JpegFile.prototype._EXIF_IDENT = "Exif\x00";
window.JpegMeta.JpegFile.prototype._types = {
    1: ["BYTE", 1],
    2: ["ASCII", 1],
    3: ["SHORT", 2],
    4: ["LONG", 4],
...
window.JpegMeta.JpegFile.prototype._tifftags = {
...
window.JpegMeta.JpegFile.prototype._exiftags = {
...
window.JpegMeta.JpegFile.prototype._gpstags = {
...
window.JpegMeta.JpegFile.prototype._markers = {
...
window.JpegMeta.JpegFile.prototype._addMetaGroup = function _addMetaGroup(name, description) {
    var group = new JpegMeta.MetaGroup(name, description);
    this[group.fieldName] = group;
    this.metaGroups[group.fieldName] = group;
    return group;
};
window.JpegMeta.JpegFile.prototype._parseIfd = function _parseIfd(endian, _binary_data, base, ifd_offset, tags, name, description) {
...
window.JpegMeta.JpegFile.prototype._jfifHandler = function _jfifHandler(mark, pos) {
...
window.JpegMeta.JpegFile.prototype._app0Handler = function app0Handler(mark, pos) {
...
window.JpegMeta.JpegFile.prototype._app1Handler = function _app1Handler(mark, pos) {
    var ident = this._binary_data.slice(pos, pos + 5);
