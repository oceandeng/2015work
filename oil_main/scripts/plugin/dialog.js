...
(function(G, D, $) {
    ...
    function Dialog(o) {
        ...
        this.config_inputType = o.inputType || 'password';
    ...
    Dialog.prototype.create = function() {
        ...
        switch(this.config_type){
            ...
            case "password":
                var html = "";
                html += "<div class='D_tit' style='color:#19273f; font-size: 16px; padding: 20px 0 10px 0'>" + this.config_title + "</div>";
                html += "<div class='D_alert'><input id='adviceInp' style='border:1px solid #ccc; font-size: 16px; width: 100%; height:40px; line-height:40px; text-align:center; background:#fff; margin: 0; padding: 0' type='number' value = '" + this.config_adviceVal + "' placeholder='请输入支付密码' />";
                html += "<div style='margin: 10px 0 0 0; overflow: hidden; height: 42px;line-height: 42px;'>"
                html += "<input id='valiCode' style='border:1px solid #ccc; font-size: 16px; width: 50%; float:left; height:40px; line-height:40px; text-align:center; background:#fff; margin: 0; padding: 0' type='text' value = '' placeholder='验证码' />";
                html += "<div id='valiBtn' data-switch='true' style='float: right; width: 40%; height:40px; line-height: 40px; background: #ff9000; text-align: center; margin: 0'>验证码</div></div></div>;"
            ...
            case "popup":
                ...
                content.className = "D_content";
                if (this.config_closeButton) {
                    head_html += '<div class="D_close" data-dialog-close style="width:'+ this.c
                    onfig_close_img_w + '; height: '+ this.config_close_img_h +'"><img src="' + this.config_close_img + '" style="max-width:100%" alt="" /></div>'
                }
                head.innerHTML = head_html;
                if (this.config_lock) {
                    parent.appendChild(shade);
