...
console.log(t);
        ...
        if (s.showInput) {
            input = $('<input type="text" style="border: none; text-align:right;" id="' + id + '" value="" class="' + s.inputClass + '" placeholder="' + (s.placeholder || '') + '" readonly />').insertBefore(elm);
